...
<div class="row"><h4>玩家宣言：<span id="playtitle"><?php echo $data['title'];?></span></h4></div>
<div id="gamepanl"></div>
<script src="__TMPL__Public/js/tuixiangzi.js" type="text/javascript" charset="utf-8"></script>
<script>
    //var leveldata=eval('('+'<?php echo $data["leveldata"];?>'+')');
    var leveldata=JSON.parse('<?php echo $data["leveldata"];?>');
    var test;
    function start(){
        $('#gamepanl').html('');
        iio.apps=[];
